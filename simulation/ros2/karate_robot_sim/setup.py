    ...
    data_files=[
        ...
        (
            ...
            [
                ...
                "launch/sensei_kick_loop.launch.py",
                "launch/sensei_rviz.launch.py",
                "launch/sensei_static_rviz.launch.py",
                "launch/sensei_start_pose.launch.py",
                "launch/sensei_walk_train.launch.py",
                "launch/sensei_walk_train_gz.launch.py",
                "launch/sensei_walk_train_short.launch.py",
                "launch/sensei_walk_train_long.launch.py",
                "launch/sensei_walk_eval_gz.launch.py",
            ],
        ),
